...
### `allelic-specific-expression/` (Figure 2A-C, Supplementary Figure 8)
...
### `induced-damage-senescence/` (Figure 2D-E)
...
### `tabula-muris-senis/` (Figure 3A-E)
...
- `glioma_T_cell_deviation.R`, `glioma_T_cell_analysis.R` — glioma-infiltrating CD8 T cells
- `melanoma_T_cell_deviation.R` — ICB-treated melanoma CD8 T cells, per timepoint
- `Terekhova_T_cell_deviation.R` — healthy-aging blood T cells (Terekhova et al. 2023)
- `Wang_aging_T_cell_deviation.R` — healthy-aging PBMC T cells (Wang et al. 2025)
...
### `aging-kidney-liver/` (Figures 5 and 7)

Aging rat kidney (proximal tubule) and aging mouse liver (hepatocyte) Multiome analyses.
